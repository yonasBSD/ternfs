...
const (
	...
	SWAP_BLOCKS_DUPLICATE_FAILURE_DOMAIN EggsError = 94
	TRANSIENT_LOCATION_COUNT EggsError = 95
	ADD_SPAN_LOCATION_INLINE_STORAGE EggsError = 96
	ADD_SPAN_LOCATION_MISMATCHING_SIZE EggsError = 97
	ADD_SPAN_LOCATION_NOT_CLEAN EggsError = 98
	ADD_SPAN_LOCATION_MISMATCHING_CRC EggsError = 99
	ADD_SPAN_LOCATION_EXISTS EggsError = 100
	SWAP_BLOCKS_MISMATCHING_LOCATION EggsError = 101
)
