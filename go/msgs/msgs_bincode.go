...
const (
	...
	CANNOT_REGISTER_DECOMMISSIONED_OR_STALE ErrCode = 68
	...
	INCONSISTENT_BLOCK_SERVICE_REGISTRATION ErrCode = 80
	SWAP_BLOCKS_INLINE_STORAGE ErrCode = 81
	SWAP_BLOCKS_MISMATCHING_SIZE ErrCode = 82
	SWAP_BLOCKS_MISMATCHING_STATE ErrCode = 83
	SWAP_BLOCKS_MISMATCHING_CRC ErrCode = 84
	SWAP_BLOCKS_DUPLICATE_BLOCK_SERVICE ErrCode = 85
	SWAP_SPANS_INLINE_STORAGE ErrCode = 86
	SWAP_SPANS_MISMATCHING_SIZE ErrCode = 87
