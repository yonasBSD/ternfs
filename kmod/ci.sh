...
# Run tests
ssh -p 2222 -i image-key fmazzol@localhost "eggs/eggstests -kmod -filter 'mounted|rsync|large' -drop-cached-spans-every 100ms -outgoing-packet-drop 0.1 -short -binaries-dir eggs"
